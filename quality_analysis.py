...
for num, im_name in enumerate(test_list):
    ...
    output2_path = os.path.join(output_dir, im_name+'_x3_output2.jpg')
    output3_path = os.path.join(output_dir, im_name+'_arcnn_40_srcnn_x3_output3.png') # TODO: change the scales
    required_width = 510; required_height = 510
...
print(PSNR_Array)
PSNR_CSV = os.path.join(outputs_dir,'PSNR.csv')
